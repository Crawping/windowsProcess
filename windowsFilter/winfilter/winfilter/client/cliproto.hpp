...
#include <winfilter/transport/client/relay.hpp>
#include <winfilter/options/continuation.hpp>
#include <winfilter/options/sanitize.hpp>
#include <winfilter/client/clievent.hpp>
#include <winfilter/client/clicreds.hpp>
#include <winfilter/client/cliconstants.hpp>
#include <winfilter/client/clihalt.hpp>
#include <winfilter/time/asiotimer.hpp>
#include <winfilter/time/coarsetime.hpp>
...
namespace winfilter {
  namespace ClientProto {
    ...
    public:
      ...
      public:
        virtual bool on_transport_recv(BufferAllocated& buf) = 0;
      };
	...
	info_hold.reset(new std::vector<ClientEvent::Base::Ptr>());
      ...
      // Add by lulei. @2018.11.08
      void set_transport_filter(TransportFilter* filter)
      {
        this->filter = filter;
      }

      // Add by lulei. @2018.11.08
      void send_data_by_transport(BufferAllocated& buf)
      {
        tun_recv(buf);
      }
