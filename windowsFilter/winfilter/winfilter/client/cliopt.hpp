...
#include <winfilter/frame/frame_init.hpp>
#include <winfilter/pki/epkibase.hpp>
#include <winfilter/crypto/cryptodcsel.hpp>
#include <winfilter/ssl/mssparms.hpp>
#include <winfilter/tun/tunmtu.hpp>
#include <winfilter/tun/ipv6_setting.hpp>
#include <winfilter/netconf/hwaddr.hpp>

#include <winfilter/transport/socket_protect.hpp>
#include <winfilter/transport/reconnect_notify.hpp>
#include <winfilter/transport/client/udpcli.hpp>
#include <winfilter/transport/client/tcpcli.hpp>
#include <winfilter/transport/client/httpcli.hpp>
#include <winfilter/transport/altproxy.hpp>
#include <winfilter/transport/dco.hpp>
#include <winfilter/client/cliproto.hpp>
#include <winfilter/client/cliopthelper.hpp>
#include <winfilter/client/optfilt.hpp>
#include <winfilter/client/clilife.hpp>

#include <winfilter/ssl/sslchoose.hpp>

#ifdef OPENVPN_GREMLIN
#include <winfilter/transport/gremlin.hpp>
#endif

#if defined(OPENVPN_PLATFORM_ANDROID)
#include <winfilter/client/cliemuexr.hpp>
#endif

#if defined(OPENVPN_EXTERNAL_TUN_FACTORY)
// requires that client implements ExternalTun::Factory::new_tun_factory
#include <winfilter/tun/extern/config.hpp>
#elif defined(USE_TUN_BUILDER)
#include <winfilter/tun/builder/client.hpp>
#elif defined(OPENVPN_PLATFORM_LINUX) && !defined(OPENVPN_FORCE_TUN_NULL)
#include <winfilter/tun/linux/client/tuncli.hpp>
#ifdef OPENVPN_COMMAND_AGENT
#include <winfilter/client/unix/cmdagent.hpp>
#endif
#elif defined(OPENVPN_PLATFORM_MAC) && !defined(OPENVPN_FORCE_TUN_NULL)
#include <winfilter/tun/mac/client/tuncli.hpp>
#include <winfilter/apple/maclife.hpp>
#ifdef OPENVPN_COMMAND_AGENT
#include <winfilter/client/unix/cmdagent.hpp>
#endif
#elif defined(OPENVPN_PLATFORM_WIN) && !defined(OPENVPN_FORCE_TUN_NULL)
#include <winfilter/tun/win/client/tuncli.hpp>
#ifdef OPENVPN_COMMAND_AGENT
#include <winfilter/client/win/cmdagent.hpp>
#endif
#else
#include <winfilter/tun/client/tunnull.hpp>
#endif

#ifdef PRIVATE_TUNNEL_PROXY
#include <winfilter/pt/ptproxy.hpp>
#endif

#if defined(ENABLE_DCO)
#include <winfilter/dco/dcocli.hpp>
#endif
...
namespace winfilter {
  ...
  public:
	...
	tcp_queue_limit(64),
	socket_recv_buf_size(65536),
	socket_send_buf_size(65536),
	...
	throw option_error("DCO not enabled in this build");
	  ...
	  socket_recv_buf_size = opt.get_num<decltype(socket_recv_buf_size)>("rcvbuf", 1, socket_recv_buf_size, 10000, 100000);
	  socket_send_buf_size = opt.get_num<decltype(socket_send_buf_size)>("sndbuf", 1, socket_send_buf_size, 10000, 100000);
	  ...
	  if (transport_protocol.is_udp())
	    {
		  ...
		  udpconf->socket_recv_buf_size = socket_recv_buf_size;
		  udpconf->socket_send_buf_size = socket_send_buf_size;
#ifdef OPENVPN_GREMLIN
...
#endif
		  tcpconf->socket_recv_buf_size = socket_recv_buf_size;
		  tcpconf->socket_send_buf_size = socket_send_buf_size;
