...
#include <winfilter/common/version.hpp>
#include <winfilter/common/platform_name.hpp>
...
#include <winfilter/common/socktypes.hpp>
...
#include <winfilter/buffer/safestr.hpp>
#include <winfilter/buffer/bufcomposed.hpp>
#include <winfilter/time/time.hpp>
#include <winfilter/time/durhelper.hpp>
#include <winfilter/frame/frame.hpp>
#include <winfilter/random/randapi.hpp>
#include <winfilter/crypto/cryptoalgs.hpp>
#include <winfilter/crypto/cryptodc.hpp>
#include <winfilter/crypto/cipher.hpp>
#include <winfilter/crypto/ovpnhmac.hpp>
#include <winfilter/crypto/tls_crypt.hpp>
#include <winfilter/crypto/packet_id.hpp>
#include <winfilter/crypto/static_key.hpp>
#include <winfilter/crypto/bs64_data_limit.hpp>
#include <winfilter/log/sessionstats.hpp>
#include <winfilter/ssl/protostack.hpp>
#include <winfilter/ssl/psid.hpp>
#include <winfilter/ssl/tlsprf.hpp>
#include <winfilter/ssl/datalimit.hpp>
...
#include <winfilter/ssl/proto_context_options.hpp>
#include <winfilter/ssl/peerinfo.hpp>
#include <winfilter/ssl/ssllog.hpp>
...
namespace winfilter {
  ...
  private:
    ...
    {
      std::string ret = winfilter::to_string(now_->raw());
      ret += is_server() ? " SERVER[" : " CLIENT[";
      if (primary)
	ret += winfilter::to_string(primary->key_id());
      if (secondary)
	{
	  ret += '/';
	  ret += winfilter::to_string(secondary->key_id());
	}
      ret += ']';
      return ret;
    }
