...
#include <winfilter/common/arraysize.hpp>
...
#include <winfilter/tun/win/tunutil.hpp>
#include <winfilter/tun/win/client/setupbase.hpp>

#if _WIN32_WINNT >= 0x0600 // Vista+
#include <winfilter/tun/win/nrpt.hpp>
#include <winfilter/tun/win/wfp.hpp>
#endif
	...
	if (local4)
	  {
		...
		create.add(new WinCmd("netsh interface ip set address " + tap_index_name + " static " + local4->address + ' ' + "255.255.255.255" + " store=active"));
		destroy.add(new WinCmd("netsh interface ip delete address " + tap_index_name + ' ' + local4->address + " store=active"));
	      }
	  }
